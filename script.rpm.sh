...
main ()
{
  ...
  yum_repo_config_url="http://packages.gitlab.cc/install/gitlab-ce/config_file_${os}_${dist}.list"
  ...
  yum install -y pygpgme --disablerepo='gitlab-ce'
  ...
  yum install -y yum-utils --disablerepo='gitlab-ce'
  ...
  yum -q makecache -y --disablerepo='*' --enablerepo='gitlab-ce'
